...
var point = require('chartist-plugin-pointlabels')
// ##############################
...
const straightLinesChart = {
  ...
  options: {
    ...
    showArea: true, // creative tim: we recommend you to set the high sa the biggest value + something for a better look
    chartPadding: {
      top: 0,
      right: 0,
      bottom: 0,
