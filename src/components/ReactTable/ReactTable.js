          ...
          <div className="-pagination">
            <div className="-previous">
              <button
                ...
                className="-btn"
                style={{color: 'white', backgroundColor: 'rgba(0,0,0,.5)'}}
              >
                Previous
              </button>
            </div>
                  ...
                  return !column.hidden ? (          
                    <th
                      ...
                      className={classnames("rt-th rt-resizable-header", {
                        "-cursor-pointer": column.Header !== 'Actions',
                        "-sort-asc": column.isSorted && !column.isSortedDesc,
                        "-sort-desc": column.isSorted && column.isSortedDesc,
                        "noevents": column.Header === 'Actions'
                      })}
                    >
                      <div className={`rt-resizable-header-content ${column.className}`}>
